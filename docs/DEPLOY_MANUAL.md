...
Swagger UI and ReDoc are available at `http://127.0.0.1:8000/docs` and `http://127.0.0.1:8000/redoc` when `DEBUG=true`. They are disabled automatically in production (`DEBUG=false`).
...
8. Browse API docs locally (requires `DEBUG=true`): `http://127.0.0.1:8000/docs` (Swagger UI) or `http://127.0.0.1:8000/redoc`.
